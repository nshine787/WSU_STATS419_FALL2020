...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{measure.males.df =}\StringTok{ }\KeywordTok{grabGenderRows}\NormalTok{(measure.df,}\StringTok{\textquotesingle{}m\textquotesingle{}}\NormalTok{)}
\NormalTok{measure.females.df =}\StringTok{ }\KeywordTok{grabGenderRows}\NormalTok{(measure.df,}\StringTok{\textquotesingle{}f\textquotesingle{}}\NormalTok{)}
...
\KeywordTok{buildLatexCorrelationTable}\NormalTok{(myData, }
  ...
  \DataTypeTok{round.digits =} \KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{2}\NormalTok{),  }\CommentTok{\# M, SD, corr}
  \CommentTok{\# myNames = c("Diameter (in)", "Height (ft)", "Volume (ft$\^{}3$)") }
...
\KeywordTok{buildLatexCorrelationTable}\NormalTok{(myData, }
  ...
  \DataTypeTok{myFile =}\NormalTok{ file.correlation,}
  \DataTypeTok{round.digits =} \KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{2}\NormalTok{),}
  \CommentTok{\# myNames = c("Diameter (in)", "Height (ft)", "Volume (ft$\^{}3$)") }
