...
\NormalTok{path.my.github =}\StringTok{ "https://raw.githubusercontent.com/nshine787/WSU\_STATS419\_FALL2020/"}\NormalTok{;}
\KeywordTok{source\_url}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(path.my.github, }\StringTok{\textquotesingle{}master/functions/functions{-}project{-}measure.R\textquotesingle{}}\NormalTok{))}

\NormalTok{relevantColumns =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}height\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}head.height\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}arm.span\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{barplot}\NormalTok{(}\KeywordTok{sort}\NormalTok{(}\KeywordTok{table}\NormalTok{(measure.df}\OperatorTok{$}\NormalTok{ethnicity),}\DataTypeTok{decreasing=}\OtherTok{TRUE}\NormalTok{), }\DataTypeTok{main =} \StringTok{\textquotesingle{}Ethnicity\textquotesingle{}}\NormalTok{,}
        \DataTypeTok{ylab =} \StringTok{\textquotesingle{}Number of Subjects\textquotesingle{}}\NormalTok{)}
\KeywordTok{barplot}\NormalTok{(}\KeywordTok{sort}\NormalTok{(}\KeywordTok{table}\NormalTok{(measure.df}\OperatorTok{$}\NormalTok{gender),}\DataTypeTok{decreasing=}\OtherTok{TRUE}\NormalTok{), }\DataTypeTok{main =} \StringTok{\textquotesingle{}Gender\textquotesingle{}}\NormalTok{, }
        \DataTypeTok{ylab =} \StringTok{\textquotesingle{}Number of Subjects\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{proportions.both =}\StringTok{ }\KeywordTok{merge.data.frame}\NormalTok{(myDataMale,myDataFemale,}\DataTypeTok{all.x=}\OtherTok{TRUE}\NormalTok{)}

\KeywordTok{plot}\NormalTok{(proportions.both}\OperatorTok{$}\NormalTok{hand.length,proportions.both}\OperatorTok{$}\NormalTok{head.height, }
     \DataTypeTok{xlab =} \StringTok{\textquotesingle{}Hand Length Proportion\textquotesingle{}}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{\textquotesingle{}Head Height Proportion\textquotesingle{}}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(proportions.both}\OperatorTok{$}\NormalTok{head.height}\OperatorTok{\textasciitilde{}}\NormalTok{proportions.both}\OperatorTok{$}\NormalTok{hand.length), }\DataTypeTok{col=}\StringTok{\textquotesingle{}red\textquotesingle{}}\NormalTok{)}

\KeywordTok{plot}\NormalTok{(proportions.both}\OperatorTok{$}\NormalTok{hand.length, proportions.both}\OperatorTok{$}\NormalTok{foot.length, }
     \DataTypeTok{xlab =} \StringTok{\textquotesingle{}Hand Length Proportion\textquotesingle{}}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{\textquotesingle{}Foot Length Proportion\textquotesingle{}}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\KeywordTok{lm}\NormalTok{(proportions.both}\OperatorTok{$}\NormalTok{foot.length}\OperatorTok{\textasciitilde{}}\NormalTok{proportions.both}\OperatorTok{$}\NormalTok{hand.length), }\DataTypeTok{col=}\StringTok{\textquotesingle{}red\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{proportions.vitruvian =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.125}\NormalTok{,}\DecValTok{1}\NormalTok{,}\FloatTok{0.1}\NormalTok{,}\FloatTok{0.1666667}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.25}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{dim}\NormalTok{(myData)[}\DecValTok{2}\NormalTok{])}
\NormalTok{\{}
  \KeywordTok{print}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(myData)[i])}
\NormalTok{  test.result =}\StringTok{ }\KeywordTok{t.test}\NormalTok{(myData[,i], }\DataTypeTok{mu=}\NormalTok{proportions.vitruvian[i], }\DataTypeTok{alternative=}\StringTok{\textquotesingle{}two.sided\textquotesingle{}}\NormalTok{)}
  \KeywordTok{print}\NormalTok{(test.result}\OperatorTok{$}\NormalTok{p.value)}
  \KeywordTok{print}\NormalTok{(test.result}\OperatorTok{$}\NormalTok{conf.int)}
\NormalTok{  error =}\StringTok{ }\KeywordTok{abs}\NormalTok{(test.result}\OperatorTok{$}\NormalTok{conf.int[}\DecValTok{1}\NormalTok{]}\OperatorTok{{-}}\NormalTok{test.result}\OperatorTok{$}\NormalTok{conf.int[}\DecValTok{2}\NormalTok{])}\OperatorTok{/}\NormalTok{proportions.vitruvian[i]}
  \KeywordTok{print}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}Error percent: \textquotesingle{}}\NormalTok{,error))}
...
\NormalTok{myDataFemale =}\StringTok{ }\NormalTok{proportions.female[,}\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}head.height\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}arm.span\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}hand.length\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}foot.length\textquotesingle{}}
\NormalTok{                                     ,}\StringTok{\textquotesingle{}floor.kneepit\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}shoulder.width\textquotesingle{}}\NormalTok{)]}
\NormalTok{proportions.vitruvian =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.125}\NormalTok{,}\DecValTok{1}\NormalTok{,}\FloatTok{0.1}\NormalTok{,}\FloatTok{0.1666667}\NormalTok{,}\FloatTok{0.25}\NormalTok{,}\FloatTok{0.25}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{dim}\NormalTok{(myData)[}\DecValTok{2}\NormalTok{])}
\NormalTok{\{}
  \KeywordTok{print}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(myData)[i])}
\NormalTok{  test.result =}\StringTok{ }\KeywordTok{t.test}\NormalTok{(myDataMale[,i],myDataFemale[,i])}
  \KeywordTok{print}\NormalTok{(test.result}\OperatorTok{$}\NormalTok{p.value)}
  \KeywordTok{print}\NormalTok{(test.result}\OperatorTok{$}\NormalTok{conf.int)}
\NormalTok{\}}
\end{Highlighting}
