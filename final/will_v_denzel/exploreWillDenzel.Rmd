...
willGenresMetaPlot = ggplot(data=will.top5,aes(x=genre,y=metacritic)) + geom_bar(stat='identity',fill='blue') +
  scale_x_discrete(limits=will.top5$genre) + ggtitle('Will\'s Movie Score by Genre') + ylim(0,100)

denzelGenresMetaPlot = ggplot(data=denzel.top5,aes(x=genre,y=metacritic)) + geom_bar(stat='identity',fill='red') +
  scale_x_discrete(limits=denzel.top5$genre) + ggtitle('Denzel\'s Movie Score by Genre') + ylim(0,100)
...
denzelRatedPie = ggplot(denzelRated, aes(x="", y=count, fill=rating)) +
  geom_bar(stat="identity", width=1, color='white') +
  coord_polar("y", start=0) +
  theme_void()

willRatedPie = ggplot(willRated, aes(x="", y=count, fill=rating)) +
  geom_bar(stat="identity", width=1, color='white') +
  coord_polar("y", start=0) +
  theme_void()
