---
title: 'R Notebook: Workspace Audit for nathan_shine'
output:
  html_document:
    df_print: paged
    toc: true
...
```{r}
wsu.id = "nathan_shine"; # change this to yours.
github.repository = "nshine787/WSU_STATS419_FALL2020";
...
<div>**Source: <a href="https://github.com/nshine787/WSU_STATS419_FALL2020/graphs/code-frequency">GitHub</a>**</div>


### Commit Frequency on GitHub
Browse to <https://github.com/nshine787/WSU_STATS419_FALL2020/graphs/commit-activity> where you replace my repository name with yours.  Screenshot and include the graphic in this folder, named "github-commits.png". 

<IMG src='github-commits.png' style="border: 2px black solid;" />
<div>**Source: <a href="https://github.com/nshine787/WSU_STATS419_FALL2020/graphs/commit-activity">GitHub</a>**</div>


## General Workspace Environment Data
```{r}
path.to.git.local = "C:/Users/Nathan/Documents/GitHub/WSU_STATS419_FALL2020/";
...
#raw.df;
raw.df = raw.df[raw.df$content.b != "",]
...
I deserve 40/50 points because while I used the workspace model provided (Git, Github, Rstudio) I did not always use them consistently or as much as I could have. I used RStudio consistently because this is what our assignments, projects, and teaching files were in, so this was no problem. I was really happy to learn how to use Git and Github in this class because they always seemed kind of confusing and I knew it was a good idea to learn how they worked. Since being introduced to both in this class, I have become much more comfortable using them and have even used both in one of my Python projects! However, a lot of the time I only worked locally on my machine, especially when working with the teaching notebooks. During the midterm project I definitely used Git and Github a lot more because this way I would have a good backup system in place in case anything happened.
</pre>
